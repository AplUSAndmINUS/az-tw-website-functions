...
{
    public static AuthorDTO ToDTO(AuthorEntity author, AuthorImagesMetadataEntity? image)
    {
        return new AuthorDTO
        {
            ...
            HasValidProfileImage = image != null,
            ProfileImageFileName = image?.ProfileImageFileName,
            ProfileImageCdnUrl = image?.ProfileImageCdnUrl,
