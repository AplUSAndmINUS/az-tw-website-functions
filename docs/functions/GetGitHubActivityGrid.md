## 📘 Function Documentation: `GetGitHubActivityGrid`

### 🧠 Overview
Retrieves a specific githubactivitygrid by its unique identifier (slug) with optional media information.
...
```bash
curl -X GET \
  http://localhost:7071/github/activity \
